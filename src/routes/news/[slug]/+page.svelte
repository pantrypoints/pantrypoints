...
<div class="page-transition">
	<div 
		class="relative flex min-h-[400px] items-end overflow-hidden px-4 py-16 sm:px-6 lg:px-8"
		...
		{#if hasImage}
			...
			<div class="absolute inset-0 z-10 bg-gradient-to-t from-black/80 to-black/40"></div>
		...
		{:else}
			<!-- No image version - original styling -->
