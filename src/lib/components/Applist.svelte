			...
			<div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
				{#each results as item, i (item.slug)}
					<a 
						...
						class="group block rounded-2xl border-2 border-slate-200 bg-white p-6 shadow-sm transition-all hover:border-brand-blue dark:border-slate-800 dark:bg-slate-900"
					>
